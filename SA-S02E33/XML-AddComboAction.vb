...
' We create a child element "trigger" for the Offset Time with the Attribute "action" set to "Combo"
...
ActionNode.Value = "Combo"                                   ' Set the "action" to "Combo"
