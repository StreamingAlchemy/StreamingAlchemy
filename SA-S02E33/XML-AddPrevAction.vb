...
' We create a child element "trigger" for the Offset Time with the Attribute "action" set to "Prev"
...
ActionNode.Value = "Prev"                                   ' Set the "action" to "Prev"
