...
' We create a child element "trigger" for the Offset Time with the Attribute "action" set to "Video"
...
ActionNode.Value = "Video"                                   ' Set the "action" to "Video"
