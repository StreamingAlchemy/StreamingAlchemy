...
Dim FILE_PATH as String = "C:\\Users\\JM\\Desktop\\SA-S02E33\\SA-SlideTimes.xml"
...
' We create a child element "trigger" for the Offset Time with the Attribute "action" set to "Slide"
...
ActionNode.Value = "Slide"                                   ' Set the "action" to "Slide"
NextOffsetNode.InnerText = TimeOffset                       ' Assign "Offset Time" to the "trigger" 
NextOffsetNode.Attributes.SetNamedItem(ActionNode)          ' Assign "Slide" to the "action"
